...
let dessert = "ColdStone Icecream Cake";
favoriteFoods.push(dessert);
console.log("Added another unhealthey food to end", favoriteFoods);
...
let entree = "Hamburger";
favoriteFoods.unshift(entree);
console.log(`Added an EXTREMELY fancy entree to the beginning: ${favoriteFoods}`);
...
console.log(`The color ${lastColor} was removed from "colors." The colors are now: ${colors}.`);
...
console.log("The color", firstColor, "was removed. The colors are now", colors);
...
console.log("The new gems are:", gems);

// 5.b (STRETCH) TODO: Sort your gems array in reverse alphabetical order.
//     Please console.log the sorted array.

let sortedGems = gems.sort().reverse();
console.log("The reverse-alphabetized gems are", sortedGems);
...
console.log("We are the colorful gems:", colorfulGems);
